...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--iterations", type=int, default=1024, help="Total Double-Spider iterations T")
...
def main() -> int:
    ...
    q_effective = int(max(1, min(float(sampling_params["q"]), float(args.iterations))))
